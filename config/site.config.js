...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@miwu04.icu',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/miwu04/onedrive-vercel-index',
    },
  ],
